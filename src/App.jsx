          ...
          <main className="relative z-10 px-8 max-w-7xl mx-auto">
              ...
              <div className="flex-1 text-white space-y-6 pt-16 md:pt-40 order-last md:order-none">
                ...
                <motion.div
                  ...
                  <a
                    ...
                    className="group relative flex h-12 w-12 items-center justify-center rounded-full border border-slate-700 bg-slate-900/[0.8] text-white transition-all duration-300 hover:border-cyan-400 hover:bg-slate-800 hover:shadow-[0_0_24px2px#00ffdc]">
              ...
              <div className="flex flex-col md:flex-row items-center justify-center">
                ...
                <motion.div
                  ...
                  <p className="text-white/80 leading-relaxed mt-4 font-cascadia text-justify">
                    ...
                    Global Mandiri Palembang yang memiliki minat besar dalam
                    pengembangan Front-End dan teknologi web modern. Saya selalu
                    bersemangat untuk belajar hal baru dan menciptakan solusi
            ...
            <footer className="py-8 text-center text-gray-400">
              <div className="text-sm">
                © {new Date().getFullYear()} TheRipperX. All rights reserved.
              </div>
